...
//Strip the word "Original" from the entire file to get the unchanged WiiuseJGuiTest -Eddie



public class OriginalWiiuseJGuiTest extends javax.swing.JFrame implements
		WiimoteListener {
...
//                        }
	 ...
	 */
	public OriginalWiiuseJGuiTest(Wiimote wiimote, Wiimote wiimote2) {
		initComponents();
		this.addWindowListener(new CloseGuiTestCleanly());
